...
public class WeeklyTopStoriesDigestPerTopicProcessorUnitTests {
    ...
    public void process_noStoriesAndNoUsers_digestCreatedWithNoStoryAndNoUsers() throws Exception {
        ...
        verify(userTopicMappingService).findAllByTopicIsAndInterestedToIsNullOrInterestedToIsAfterAndInterestedFromBefore(any(Topic.class),
                                                                                                                          any(Timestamp.class),
                                                                                                                          any(Timestamp.class));
    }
    ...
    public void process_1StoriesButNoUsers_digestCreatedWithStoryButNoUsers() throws Exception {
        ...
        assertEquals(expectedDigest, digests.get(0));
        verify(storiesService).getUndeletedStoriesContainingKeywordAndAfterTimestamp(anyString(), any(Timestamp.class));
        verify(userTopicMappingService)
                .findAllByTopicIsAndInterestedToIsNullOrInterestedToIsAfterAndInterestedFromBefore(any(Topic.class),
                                                                                                   any(Timestamp.class),
                                                                                                   any(Timestamp.class));
    }
    ...
    public void process_multipleStoriesWithUser_digestCreatedWithTopStoriesAndUser() throws Exception {
        ...
        when(storiesService
                .getUndeletedStoriesContainingKeywordAndAfterTimestamp(anyString(), any(Timestamp.class)))
                                                    .thenReturn(Arrays.asList(story1, story2, story3, story4, story5));
        ...
        when(userTopicMappingService
                .findAllByTopicIsAndInterestedToIsNullOrInterestedToIsAfterAndInterestedFromBefore(any(Topic.class),
                                                                                                   any(Timestamp.class),
                                                                                                   any(Timestamp.class)))
                                                    .thenReturn(Arrays.asList(userTopicMapping1, userTopicMapping2));
